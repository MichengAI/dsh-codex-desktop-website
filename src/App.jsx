...
const translations = {
  ...
  "Git 提交图谱": "Git commit graph", "放大查看 Git 提交图谱": "Open Git commit graph", "查看仓库提交历史与分支关系。": "Explore repository commit history and branch relationships.",
