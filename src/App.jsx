  ...
  return <div className="site-shell">
    ...
    <main id="top">
      <section className="hero page-width" aria-labelledby="hero-title">
        ...
        <figure className="hero-product"><img src="https://raw.githubusercontent.com/MichengAI/dsh-codex-desktop/main/assets/screenshots/desktop-conversation-dark.png" alt="DSH Codex Desktop 的 Codex UI 会话工作区" /><figcaption><span>CODEX UI</span><span>项目、任务与会话</span></figcaption></figure>
      </section>
