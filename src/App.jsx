...
const translations = {
  ...
  "DSH Codex Desktop 产品总览": "DSH Codex Desktop product overview", "放大查看 DSH Codex Desktop 产品总览": "Open DSH Codex Desktop product overview", "Codex UI 与六个随附插件": "Codex UI and six bundled plugins",
  ...
  "安装桌面端后，可以在 Codex UI 中处理项目、任务和会话；专家预设、技能、归档、IM Connect 和自动化作为独立组件随应用提供。": "Use Codex UI for projects, tasks, and conversations. Expert presets, skills, archives, IM Connect, and automation are included as independent components.",
  ...
  "插件集合开箱即用": "Plugins are ready to use", "六个功能插件随首次启动准备完成，按你的工作方式选择并持续扩展。": "Six functional plugins are prepared on first launch. Choose what fits your workflow and extend it over time.",
